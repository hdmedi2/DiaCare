...
const buildVersionJson = JSON.parse(fs.readFileSync(buildVersionPath, 'utf8'));
...
buildVersionJson.buildVersion = packageJson.version;

// package.json 파일에 쓰기
fs.writeFileSync(packageJsonPath, JSON.stringify(packageJson, null, 2));
fs.writeFileSync(packageLockJsonPath, JSON.stringify(packageLockJson, null, 2));
fs.writeFileSync(buildVersionPath, JSON.stringify(buildVersionJson, null, 2));
